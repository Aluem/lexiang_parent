package top.lexiang.system.config;
...
import top.lexiang.system.shiro.realm.UserRealm;
...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shiroFilter(DefaultWebSecurityManager defaultWebSecurityManager) {
        ...
        //anon -- 匿名访问
        filterMap.put("/system/user/login", "anon"); //登录
        //filterMap.put("/system/user/info", "anon"); //登录
        filterMap.put("/system/user/save", "anon"); //注册
        filterMap.put("/system/user/get/**", "anon"); //根据id查询用户
